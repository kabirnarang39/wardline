...
func TestHandler_AuditEndpoint_ReturnsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(audit, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_PolicyEndpoint_ReturnsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{}, policy, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_StatusEndpoint_ReturnsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{status: status}, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleStatus_IncludesCallerTenant(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, status, domain.PolicyInfo{}, testAssets(), nil, nil, nil, scope, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleStatus_CallerTenantEmptyWhenScopeNil(t *testing.T) {
	status := &fakeStatusSource{status: domain.StatusInfo{Version: "test"}}
	h := adapter.NewHandler(&fakeAuditSource{}, status, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleStatus_IncludesCallerIdentity(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, status, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, info, nil, nil, nil, nil, nil, nil)
...
func TestHandler_ServesKnownStaticAsset(t *testing.T) {
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleAnomalies_ReturnsBufferedEntriesAsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), anomalies, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleRBAC_ReturnsRolesAndBindingsAsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, rbac, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleBudget_ReturnsDefaultAndOverridesAsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, budget, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleFederationCorrelated_ReturnsBufferedEntriesAsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), nil, federation, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleBlocked_ReturnsListAsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), nil, nil, blocked, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_TenantScopedCaller_OnlySeesOwnTenant(t *testing.T) {
	...
	h := adapter.NewHandler(audit, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), anomalies, nil, blocked, fakeTenantScopeResolver{tenant: "acme"}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_GloballyGrantedCaller_SeesAllTenants(t *testing.T) {
	audit, anomalies, blocked := tenantScopedFixtures()
	h := adapter.NewHandler(audit, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), anomalies, nil, blocked, fakeTenantScopeResolver{tenant: ""}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_NilScopeResolver_Unfiltered(t *testing.T) {
	audit, anomalies, blocked := tenantScopedFixtures()
	h := adapter.NewHandler(audit, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), anomalies, nil, blocked, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_FederationRoute_StaysUnfiltered(t *testing.T) {
	...
	h := adapter.NewHandler(&fakeAuditSource{}, &fakeStatusSource{}, domain.PolicyInfo{}, testAssets(), nil, federation, nil, fakeTenantScopeResolver{tenant: "acme"}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_UnblockRoute_RequiresUnblockAuthorizer(t *testing.T) {
	...
	scope := fakeTenantScopeResolver{tenant: "acme"}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, blocked, scope, denyAllUnblockAuthorizer{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_UnblockRoute_CallsUnblockWithResolvedTenant(t *testing.T) {
	blocked := &fakeBlockedSource{unblockResult: true}
	scope := fakeTenantScopeResolver{tenant: "acme"}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, blocked, scope, allowAllUnblockAuthorizer{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_UnblockRoute_AllowedForReceivesResolvedTargetTenant(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, blocked, scope, authz, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_UnblockRoute_NonDeleteMethod_Returns405(t *testing.T) {
	blocked := &fakeBlockedSource{unblockResult: true}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, blocked, nil, allowAllUnblockAuthorizer{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_ReloadRoute_NonPostMethod_Returns405(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, coordinator, allowReloadAuthorizer{identity: "alice"}, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_ReloadRoute_NilCoordinatorOrAuth_Returns404(t *testing.T) {
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_ReloadRoute_AuthorizerDenies_Returns403(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, coordinator, denyReloadAuthorizer{}, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleReloadHistory_ReturnsBufferedEntriesAsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, history, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleReloadHistory_TakesPrecedenceOverReloadPrefixRoute(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, coordinator, allowReloadAuthorizer{identity: "alice"}, &fakeReloadHistorySource{}, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_HandleReloadHistory_NonGetMethod_Returns405(t *testing.T) {
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, &fakeReloadHistorySource{}, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_PolicyWriteRoute_MethodFieldReachesWriteAndReload(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, updated, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, allowReloadAuthorizer{identity: "alice"}, nil, nil, writer, nil, nil, nil, nil, nil)
...
func TestHandler_PolicyWriteRoute_GetStillReturnsPolicyInfo(t *testing.T) {
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{Backend: "yaml", Source: "rules: []\ndefault: allow\n"}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_PolicyWriteRoute_AuthorizerDenies_Returns403(t *testing.T) {
	writer := &fakePolicyWriter{}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, denyReloadAuthorizer{}, nil, nil, writer, nil, nil, nil, nil, nil)
...
func TestHandler_PolicyWriteRoute_WriterError_Returns400WithMessage(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, allowReloadAuthorizer{identity: "alice"}, nil, nil, writer, nil, nil, nil, nil, nil)
...
func TestHandler_BudgetWriteRoute_GetStillReturnsBudget(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, src, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_BudgetWriteRoute_AuthorizerDenies_Returns403(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, denyReloadAuthorizer{}, nil, nil, nil, writer, nil, nil, nil, nil)
...
func TestHandler_BudgetWriteRoute_Success_AppliedByFromAuthorizer(t *testing.T) {
	writer := &fakeBudgetWriter{}
	src := &fakeBudgetSource{defaultLimit: budgetdomain.LimitInfo{RequestsPerWindow: 25, Window: 60 * time.Second}}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, src, nil, allowReloadAuthorizer{identity: "alice"}, nil, nil, nil, writer, nil, nil, nil, nil)
...
func TestHandler_BudgetWriteRoute_WriterError_Returns400WithMessage(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, allowReloadAuthorizer{identity: "alice"}, nil, nil, nil, writer, nil, nil, nil, nil)
...
func TestHandler_HandleCompliance_ReturnsManifestAsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, src, nil, nil, nil)
...
func TestHandler_HandleApprovals_ReturnsPendingAsJSON(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, appr, nil, nil)
...
func TestHandler_HandleApprovalDecision_DenyingAuthorizerReturns403(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, denyReloadAuthorizer{}, nil, nil, nil, nil, nil, appr, nil, nil)
...
func TestHandler_HandleApprovalDecision_AllowingReturns204AndCallsSource(t *testing.T) {
	appr := &fakeApprovalSource{}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, allowReloadAuthorizer{identity: "op@acme"}, nil, nil, nil, nil, nil, appr, nil, nil)
...
// --- Task 11: dashboard job-budget view ---

// fakeJobBudgetSource is a settable stub for adapter.JobBudgetSource --
// returns fixed entries, matching this file's fake pattern for every other
// read-only Source interface.
type fakeJobBudgetSource struct {
	entries []jobbudgetdomain.Entry
}

func (f *fakeJobBudgetSource) ListNearCeiling(limit int) []jobbudgetdomain.Entry {
	return f.entries
}

func TestHandler_HandleJobBudget_NilSourceReturns404(t *testing.T) {
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)

	req := httptest.NewRequest(http.MethodGet, "/dashboard/api/job-budget", nil)
	rec := httptest.NewRecorder()
	h.ServeHTTP(rec, req)

	if rec.Code != http.StatusNotFound {
		t.Fatalf("expected 404 when job-budget is not wired (feature off), got %d", rec.Code)
	}
}

func TestHandler_HandleJobBudget_ReturnsEntriesAsJSON(t *testing.T) {
	src := &fakeJobBudgetSource{entries: []jobbudgetdomain.Entry{
		{Key: "8:acmealice-session-1", Count: 42},
		{Key: "6:acmebob-session-2", Count: 10},
	}}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, src, nil)
	...
	var got []jobbudgetdomain.Entry
	if err := json.Unmarshal(rec.Body.Bytes(), &got); err != nil {
		t.Fatalf("response is not valid JSON: %v", err)
	}
	if len(got) != 2 || got[0].Key != "8:acmealice-session-1" || got[0].Count != 42 {
		t.Errorf("unexpected decoded response: %+v", got)
	}
}

func TestHandler_HandleJobBudget_MethodNotAllowedForNonGET(t *testing.T) {
	src := &fakeJobBudgetSource{}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, src, nil)

	req := httptest.NewRequest(http.MethodPost, "/dashboard/api/job-budget", nil)
	rec := httptest.NewRecorder()
	h.ServeHTTP(rec, req)

	if rec.Code != http.StatusMethodNotAllowed {
		t.Fatalf("want 405 for non-GET, got %d", rec.Code)
	}
}

// --- Task 10: dashboard cost-budget view ---

// fakeCostBudgetSource is a settable stub for adapter.CostBudgetSource --
// returns fixed entries, matching this file's fake pattern for every other
// read-only Source interface (see fakeJobBudgetSource above).
type fakeCostBudgetSource struct {
	entries []costbudgetdomain.Entry
}

func (f *fakeCostBudgetSource) ListNearCeiling(limit int) []costbudgetdomain.Entry {
	return f.entries
}

func TestHandler_HandleCostBudget_NilSourceReturns404(t *testing.T) {
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)

	req := httptest.NewRequest(http.MethodGet, "/dashboard/api/cost-budget", nil)
	rec := httptest.NewRecorder()
	h.ServeHTTP(rec, req)

	if rec.Code != http.StatusNotFound {
		t.Fatalf("expected 404 when cost-budget is not wired (feature off), got %d", rec.Code)
	}
}

func TestHandler_HandleCostBudget_ReturnsEntriesAsJSON(t *testing.T) {
	src := &fakeCostBudgetSource{entries: []costbudgetdomain.Entry{
		{Key: "8:acmealice-session-1", Total: 4200},
		{Key: "6:acmebob-session-2", Total: 1000},
	}}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, src)
	...
	var got []costbudgetdomain.Entry
	if err := json.Unmarshal(rec.Body.Bytes(), &got); err != nil {
		t.Fatalf("response is not valid JSON: %v", err)
	}
	if len(got) != 2 || got[0].Key != "8:acmealice-session-1" || got[0].Total != 4200 {
		t.Errorf("unexpected decoded response: %+v", got)
	}
}

func TestHandler_HandleCostBudget_MethodNotAllowedForNonGET(t *testing.T) {
	src := &fakeCostBudgetSource{}
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, src)

	req := httptest.NewRequest(http.MethodPost, "/dashboard/api/cost-budget", nil)
	rec := httptest.NewRecorder()
	h.ServeHTTP(rec, req)
