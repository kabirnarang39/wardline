...
func TestHandler_ReloadRoute_NonPostMethod_Returns405(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, coordinator, allowReloadAuthorizer{identity: "alice"})
...
func TestHandler_ReloadRoute_NilCoordinatorOrAuth_Returns404(t *testing.T) {
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, nil, nil)
...
func TestHandler_ReloadRoute_AuthorizerDenies_Returns403(t *testing.T) {
	...
	h := adapter.NewHandler(nil, nil, domain.PolicyInfo{}, testAssets(), nil, nil, nil, nil, nil, coordinator, denyReloadAuthorizer{})
