...
| `export-evidence --config <file> --from <date> --to <date> --output <path>` | Export a compliance evidence bundle (see [Compliance Evidence Export](/features/compliance-evidence-export/)). |
