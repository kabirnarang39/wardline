...
// IdentityResolver resolves the caller's identity and tenant for a
// request. Structurally identical to proxyadapter.IdentityAuthenticator —
// the same already-constructed HeaderIdentity{}/bearerIdentity value wired
